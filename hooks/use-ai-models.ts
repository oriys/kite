...
export function useAiModels() {
  ...
  return {
    ...
    embeddingProviderId: catalog?.embeddingProviderId ?? '',
    embeddingModelId: catalog?.embeddingModelId ?? '',
    resolvedEmbeddingProviderId: catalog?.resolvedEmbeddingProviderId ?? '',
    resolvedEmbeddingModelId: catalog?.resolvedEmbeddingModelId ?? '',
    rerankerModelId: catalog?.rerankerModelId ?? '',

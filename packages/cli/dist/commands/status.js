...
export const statusCommand = new Command('status')
    ...
    try {
        ...
        if (counts.draft)
            console.log(`    Draft:         ${chalk.yellow(String(counts.draft))}`);
        if (counts.review)
            console.log(`    In Review:     ${chalk.blue(String(counts.review))}`);
        if (counts.published)
            console.log(`    Published:     ${chalk.green(String(counts.published))}`);
        if (counts.archived)
            console.log(`    Archived:      ${chalk.dim(String(counts.archived))}`);

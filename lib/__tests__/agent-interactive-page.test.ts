...
describe('doc agent interactive page catalog', () => {
  ...
  it('documents the interactive page tool in prompts', () => {
    ...
    expect(buildAgentSystemPrompt()).toContain('ask_page_template')
    expect(buildAgentSystemPrompt()).toContain('ask_page')
    expect(buildAgentSystemPrompt()).toContain('Interactive Page Catalog')
    expect(buildAgentSystemPrompt()).toContain('Interactive Page Templates')
  })
})
